...
if __name__ == '__main__':
                    ...
                    for en in exponent:
                        for er in exponent:
                            ...
                            for i in range(len(model_1)):
                                ...
                                new_ps = (ws * (probs_1[0] ** es)) + ((1 - ws) * (probs_2[0] ** (1/es)))
                                new_pn = (wn * (probs_1[1] ** en)) + ((1 - wn) * (probs_2[1] ** (1/en)))
                                new_pr = (wr * (probs_1[2] ** er)) + ((1 - wr) * (probs_2[2] ** (1/er)))
    ...
    output_folder_path = f"ensemble/ensemble_2/{args['model_1']}+{args['model_2']}"
