...
if __name__ == '__main__':
    ...
    ref_data_path = f"./data/{input_argument['mode']}.json"
    ...
    pred_data_path = f"./generate_label/fakenet/label/{input_argument['model']}/{input_argument['mode']}.json"
    ...
    output_folder_path = f"./generate_label/fakenet/evaluate/{input_argument['model']}"
    ...
    plt.title(f"{input_argument['model']}/{input_argument['mode']}")
    # plt.show()
